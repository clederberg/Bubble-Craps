...
Free-play craps and crapless craps in the browser. Play money only, no accounts, no purchases. Your bankroll is saved in your browser and you can reset it to $1,000 anytime.

**Play:** open `index.html`, or turn on GitHub Pages (below).

## Tables

- **Craps:** Pass / Don't Pass, Come / Don't Come, odds up to 5x, Place, Buy, Lay, Field, Hardways, one-roll props, Horn, C & E, All Small / All Tall / Make 'Em All.
...
|---|---|
| Pass / Come / Don't | 1:1 |
| Odds | true odds (2/12 6:1, 3/11 3:1, 4/10 2:1, 5/9 3:2, 6/8 6:5) |
...
- Pick a chip, tap a bet to add it.
- Right-click a bet, or switch on **Take down**, to remove chips.
- **Space** or **R** rolls.
